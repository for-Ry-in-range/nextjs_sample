        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Card>
            <CardContent className="flex flex-col items-center justify-center gap-4 p-6 text-center">
              <AtSignIcon className="h-10 w-10 text-gray-900 dark:text-gray-50" />
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center gap-4 p-6 text-center">
              <KeyboardIcon className="h-10 w-10 text-gray-900 dark:text-gray-50" />
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center gap-4 p-6 text-center">
              <ThumbsUpIcon className="h-10 w-10 text-gray-900 dark:text-gray-50" />
