...
export function Cta() {
  ...
  return (
    <section className="w-full bg-gray-800 py-12 md:py-24 lg:py-24 xl:py-24">
          ...
          <div className="flex flex-col justify-center space-y-4 text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-[600px] text-zinc-200 dark:text-zinc-100 md:text-xl">
                Get started and have AI do the work for you. It reads all the
                newsetters you want to monitor, and alerts you with only
            ...
            <div className="mx-auto w-full max-w-sm space-y-4">
              <form className="flex space-x-2" onSubmit={handleSubmit}>
                <Input
                  className="max-w-lg flex-1 border-gray-900 bg-gray-600 text-white placeholder:text-gray-300"
